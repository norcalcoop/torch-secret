 ...
 * Words ordered by dice roll: 11111 = index 0 (abacus), 66666 = index 7775 (zoom).
 * Prefix-free property: no word is a prefix of another word in this list.
 *
...
// EFF_WORDS typed as string[] — NOT readonly tuple or as const.
// Using as const on a 7,776-element literal array causes TypeScript
// language-server slowdown (literal type inference for each element).
