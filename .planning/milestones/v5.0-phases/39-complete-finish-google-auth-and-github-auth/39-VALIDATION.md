...
- [x] All tasks have `<automated>` verify or are checkpoint tasks (human-action/human-verify)
- [x] Sampling continuity: Plan 03 Task 1 has automated verify; checkpoint tasks are by nature human-verified
- [x] Wave 0: no MISSING references — auth.test.ts AUTH-06/AUTH-07 already exist; no new test files needed
- [x] No watch-mode flags
- [x] Feedback latency < 15s (auth suite runs in ~15s)
