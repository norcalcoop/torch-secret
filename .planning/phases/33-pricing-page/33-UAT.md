...
expected: |
  Navigate to /pricing. The page should render with a heading (e.g. "Simple, transparent pricing"), two pricing cards (Free and Pro), a billing toggle, and a FAQ section below.
