...
- [x] **THEME-05**: @fontsource/press-start-2p installed; font lazy-loads on retro theme activation (not for dos/mac themes); initRetroThemeListener called at app startup; PostHog 'retro_theme_activated' event fires with theme_id/name/group (no userId or secretId); Playwright E2E confirms FOWT colors appear before JS bundle executes
